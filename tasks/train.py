...
def train(cfg, model, run_dir, run_name, device):
    ...
    # ----------------------------
    metric = RecMetric(logging.getLogger(__name__))

    best_accuracy = 0.0
    history = {
        "steps": [], "train_acc": [], "ctc_loss": [], "nrtr_loss": [], "total_loss": [],
        "eval_steps": [], "eval_acc": []
    }
    epoch_history = {
        "epoch": [], "train_acc": [], "eval_acc": [], "total_loss": [],
        "ctc_loss": [], "nrtr_loss": [], "lr": [],
    }
    ...
    for epc in range(start_epoch, end_epoch):
        ...
        save_epoch_curves(run_dir, epoch_history)
