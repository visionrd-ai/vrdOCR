...
decoder = CTCLabelDecode(character_dict_path='/home/amur/Amur/vrdOCR/utils/en_dict.txt', use_space_char=True)
...
# model.load_state_dict(torch.load('/home/amur/Amur/vrdOCR/runs/vrd_rec.pth'))  #resnet_indus_scratch_docs_20241030_110738/resnet_indus_scratch_docs_e3_b2499.pth
# model.cuda()
...
head_config = {'name': 'MultiHead', 'head_list': [{'CTCHead': {'Neck': {'name': 'svtr', 'dims': 120, 'depth': 2, 'hidden_dims': 120, 'kernel_size': [1, 3], 'use_guide': True}, 'Head': {'fc_decay': 1e-05}}}, {'NRTRHead': {'nrtr_dim': 384, 'max_text_length': 150}}], 'out_channels_list': {'CTCLabelDecode': 97, 'NRTRLabelDecode': 100}, 'in_channels': 480}
model = vrdOCR(backbone_config=backbone_config, head_config=head_config).cuda()
model.load_state_dict(torch.load('/home/amur/Amur/vrdOCR/runs/HRNet_deploy_augd2_best_model.pth'))
model.cuda()
model.eval()
model.eval()
...
img_path = '/home/amur/Amur/dataset/55.png'# /home/amur/Amur/ForgeryDetectionV1.2/PaddleOCR/bottom_sents/Auto-Color0101_0.png_3_aug_17.jpg  /SC-0091564451001-2863334-20240829-131510_stamped.png_0_aug_0.jpg
